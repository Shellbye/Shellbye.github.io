...
public class LuTestIndex {
     ...
     * using the
     * [WriteLineDocTask](../../../../../contrib-benchmark/org/apache/lucene/benchmark/byTask/tasks/WriteLineDocTask.html).
     *
...
官方所给的[版本](http://lucene.apache.org/core/4_10_1/demo/src-html/org/apache/lucene/demo/SearchFiles.html)功能比较全面，也比较复杂，所以我做了一点简化，最终结果如下：
